...
Click the green code button on this github page to download the folder where the files are stored for more specifics click the "download zip" button after clicking the green code button
